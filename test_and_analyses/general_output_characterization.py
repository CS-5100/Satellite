...
def plot_episode_average(
    ...
    ax.set_ylabel("Coverage Radius, Square Kilometers")
    ax.set_xlabel("Local Search Iterations")
...
episode_iterations.savefig("episode_iterations.png", bbox_inches='tight')
episode_averages.savefig("episode_medians.png", bbox_inches='tight')
duration_distributions.savefig("duration_distributions.png", bbox_inches='tight')
coverage_distributions.savefig("coverage_distributions.png", bbox_inches='tight')
coverage_above_existing_distributions.savefig(
    "coverage_above_existing_distributions.png", bbox_inches='tight'
)
coverage_above_initial_distributions.savefig("coverage_above_initial_distributions.png", bbox_inches='tight')
percent_coverage_distributions.savefig("percent_coverage_distributions.png", bbox_inches='tight')
percent_coverage_above_existing_distributions.savefig(
    "percent_coverage_above_existing_distributions.png", bbox_inches='tight'
)
percent_coverage_above_initial_distributions.savefig(
    "percent_coverage_above_initial_distributions.png", bbox_inches='tight'
)
