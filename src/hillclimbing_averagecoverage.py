...
# Main Function
def calculate_average_added_coverage(
    num_runs=10,
    ...
    """
    Calculate the average added coverage across multiple runs of the hill climbing function.
    """
    ...
    for run in range(num_runs):
        ...
        _, optimized_land_coverage, _, _ = hill_climbing(
            ...
            num_iterations=hill_climbing_iterations,
