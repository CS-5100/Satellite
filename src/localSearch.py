...
def generate_new_satellites(
    num_satellites=60, input_map=None, true_random=True, sample_separate=True
):
...
def local_search_optimization(
    ...
    best_land_coverage = calculate_land_coverage(
        best_gdf, land_map, buffer_radius=buffer_radius
    )
    ...
    for iteration in range(num_iterations):
        ...
        new_land_coverage = calculate_land_coverage(
            new_gdf, land_map, buffer_radius=buffer_radius
        )
...
new_satellites_gdf = generate_new_satellites(
    num_satellites=30, input_map=land_map, true_random=False, sample_separate=False
)
